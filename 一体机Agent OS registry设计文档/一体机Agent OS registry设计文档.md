...
>
> 本文档只写 **1 功能列表 · 2 整体视图 · 3 场景逻辑视图 · 4 注册表示例 · 5 其他材料**；模块内部实现、接口清单见 §5 指向的[实现文档](./一体机Agent%20OS%20registry实现文档.md)与 [`registry_openapi.yaml`](./registry_openapi.yaml)。
...
- **输入示例**：
  ...
  { "framework": "opencode", "framework_version": "v0.2.0",
    "spec": { "imageurl": "harbor.local/adapted/opencode:v0.2.0-mod1.3",
...
[
  { "framework": "aider", "framework_version": "v0.8.0", "is_default": true,
    "imageurl": "harbor.local/adapted/aider:v0.8.0-mod1.3",
  ...
  { "framework": "autogen", "framework_version": "v0.4.0", "is_default": true,
    "imageurl": "harbor.local/adapted/autogen:v0.4.0-mod1.3",
    "image_module_version": "v1.3", "uploaded_by": "user-02",
    "created_at": "2026-07-01T10:00:00Z" },
  { "framework": "claude-code", "framework_version": "v1.0.0", "is_default": true,
    "imageurl": "harbor.local/adapted/claude-code:v1.0.0-mod1.3",
    "image_module_version": "v1.3", "uploaded_by": "user-02",
    "created_at": "2026-07-05T11:00:00Z" },
  { "framework": "claude-code", "framework_version": "v0.9.0", "is_default": false,
    "imageurl": "harbor.local/adapted/claude-code:v0.9.0-mod1.2",
  ...
  { "framework": "crewai", "framework_version": "v0.5.0", "is_default": true,
    "imageurl": "harbor.local/adapted/crewai:v0.5.0-mod1.3",
    "image_module_version": "v1.3", "uploaded_by": "user-02",
    "created_at": "2026-07-04T08:00:00Z" },
  { "framework": "crewai", "framework_version": "v0.4.0", "is_default": false,
    "imageurl": "harbor.local/adapted/crewai:v0.4.0-mod1.2",
  ...
  { "framework": "jiuwen-report", "framework_version": "v1.0.0", "is_default": true,
    "imageurl": "harbor.local/adapted/jiuwen-report:v1.0.0-mod1.3",
    "image_module_version": "v1.3", "uploaded_by": "system",
    "created_at": "2026-06-20T00:00:00Z" },
  { "framework": "langgraph", "framework_version": "v0.3.1", "is_default": true,
    "imageurl": "harbor.local/adapted/langgraph:v0.3.1-mod1.3",
  ...
  { "framework": "opencode", "framework_version": "v0.1.0", "is_default": false,
    "imageurl": "harbor.local/adapted/opencode:v0.1.0-mod1.1",
...
- **输出示例**：`{ "framework": "opencode", "framework_version": "v0.2.0", "imageurl": "harbor.local/adapted/opencode:v0.2.0-mod1.3", "cpu": 1000, "memory": 2048, "ports": [ { "port": 8080, "protocol": "tcp" } ], "env": { "A2X_LLM_KEY": "${A2X_LLM_KEY}" } }`
...
**注册表 `镜像注册表`**（kind=image）：**一行 = 一个框架版本**（`framework` + `framework_version`）；`is_default` 标记该框架默认版本。

| 列 | 角色 | 说明 |
|----|------|------|
| `registry` | 主键 | 恒为 `镜像注册表` |
...
| `data` | JSON | 元戎运行规格，**扁平**（一行一版本，无 `rootfs` 包装）`{imageurl, workdir, mounts, cpu, memory, ports, env, image_module_version, created_at}` |
...
```json
{ "imageurl": "harbor.local/adapted/opencode:v0.2.0-mod1.3", "workdir": "/app",
...
**注册表 `实例注册表`**（kind=instance）：一行 = 一个实例，`service_id` 由 **(user, framework) 确定性派生**（每用户每框架**一个实例**）。`status` 不落库、查询时据 node 心跳派生。

| 列 | 角色 | 说明 |
|----|------|------|
| `registry` | 主键 | 恒为 `实例注册表` |
...
| **实现文档** | [`一体机Agent OS registry实现文档.md`](./一体机Agent%20OS%20registry实现文档.md) | ① 整体项目架构；② 各模块功能与接口（依照开发顺序）|
